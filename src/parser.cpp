...
static const char *const yytname[] =
{
  ...
  "DEFAULT", "GOTO", "ADD", "SUB", "MUL", "DIV", "ADDASSIGN", "SUBASSIGN",
  "MULASSIGN", "DIVASSIGN", "AND", "OR", "XOR", "ANDASSIGN", "ORASSIGN",
  "XORASSIGN", "ANDAND", "OROR", "SL", "SR", "SLASSIGN", "SRASSIGN",
  "ASSIGN", "LT", "GT", "NOTEQ", "EQ", "TYPEDEF", "SIZEOF", "RETURN",
  "DELIM", "NUMBER", "IDENTIFIER", "$accept", "program", "declarations",
  "declaration", "var_decl", "type", YY_NULLPTR
};
#endif
...
static const yytype_int8 yystos[] =
{
      ...
      12,    64,    65,    66,    67,    68,     0,    66,    62,    60
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_int8 yyr1[] =
{
       0,    63,    64,    65,    65,    66,    67,    68,    68,    68,
...
#line 1425 "parser.cpp"
  ...
  case 3:
#line 85 "ecc.y"
                                        { (yyvsp[-1].declarations)->push_back((yyvsp[0].declaration)); }
